...
```{r write_file, include=FALSE, eval=FALSE}
write.csv(StateGov_df,
...
Inauguration Order is for the seat numbers and _Governors_ is for the total governor count. 
...
**January 10, 1769** is the earliest inaugural date and **January 16, 2018** is the latest inaugural date.

<br/>

## _How many distinct party affiliations are there?_ 

Rhode Island and Illinois shows a almost an even balance between the Republican and Democratic parties. 
...
StateAffil %>% 
  kbl(caption = "State Party Affiliations") %>% 
  kable_classic("hover",
                "condensed",
                full_width = F,
                html_font = "Optima") %>%
