...
#........... color palette ..................
political1 <- colorRampPalette(paletteer_c("grDevices::Reds 3", 30))(12)
#........... graph ................................
fig1 <- GovernorSeats %>% 
  ggplot(aes(x = Inauguration, y = Governors)) +
  geom_ribbon(aes(ymin = Governors - 5,
                  ymax = Governors + 5),
              fill = "#660000",
              alpha = 0.95) +
  geom_jitter(aes(color = "political1"),
              width = 0.4,
              size = 5.25,
              alpha = 0.5) +
  annotate("pointrange", x = 90.9, y = 1.5,
           ymin = -9,
           ymax = 20,
           color = "black",
           size = 1.5,
