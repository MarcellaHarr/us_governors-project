...
```{r qst6, out.width="100%", out.height="100%"}
#........... color scheme ................................
...
#........... graph ................................
fig6b <- ggplot(data = subset(GovernorTermDates,
...
#........... graph ................................
fig6c <- ggplot(GovernorTermDates,
               aes(x = as.factor(Affiliation),
                   y = as.factor(State),
                   group = Affiliation,
                   fill = "#69a2ff")) +
...
#   summarise(MonthIn = format(as.Date(paste0(StateGov_DF_cleaned$took_office),
#                                      format = "%Y-%m-%d"),
#                              "%B"),   # Full month name
#             MonthOut = format(as.Date(paste0(StateGov_DF_cleaned$left_office),
#                                       format = "%Y-%m-%d"),
#                               "%B"),
