...
In fact, there are only 10 different affiliations.
...
fig4 +
  geom_point(data = filter(Governors,
                           Group.1 == "South Carolina"),
             size = 0) +
...
South Carolina has the most governors so far with 91 inaugurations.

```{r qst4_answer}
Govs <- Governors[which.max(Governors$x), "Group.1"]
string4a <- "has the most with"
