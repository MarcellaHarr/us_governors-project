...
```{r qst6_Table}
GovernorTermDates[order(GovernorTermDates$Served), ] -> GovernorTermDates

GovernorTermDates$Served_z <- round(
  (GovernorTermDates$Served - mean(GovernorTermDates$Served)) / sd(GovernorTermDates$Served), 2)

# https://rpubs.com/ageek/ggplot-adv-part1
```
<br/>
...
Central states but mostly Eastern states, excluding Pennsylvania, West Virginia, and Florida, seem to have the most Governors.
